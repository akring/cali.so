  ...
  return (
    <div className="max-w-2xl">
      ...
      >
        <Balancer>
          我是 Akring，
          独立开发者 & 科技内容创作者，专注 macOS / iOS 工具类应用。
          日常在开发、设计和内容创作之间切换，也持续尝试把想法变成可用的产品。
        </Balancer>
      </motion.p>
      <motion.div
      ...
      >
        <SocialLink
          href="https://x.com/ddflj3310"
          aria-label="我的推特"
          platform="twitter"
        />
        <SocialLink
          href="https://www.youtube.com/@akring"
          aria-label="我的 YouTube"
          platform="youtube"
        />
        <SocialLink
          href="https://space.bilibili.com/433784917"
          aria-label="我的 Bilibili"
          platform="bilibili"
        />
        <SocialLink
          href="https://github.com/akring"
          aria-label="我的 GitHub"
          platform="github"
        />
        <SocialLink href="/feed.xml" platform="rss" aria-label="RSS 订阅" />
        <SocialLink
          href="mailto:service@akring.com"
          aria-label="我的邮箱"
          platform="mail"
        />
      </motion.div>
